 ...
 const progressTest = 0.2
    ...
    `,
        ...
        void main() {
			...
			vec3 red = vec3(0.729,0.847,0.698);
    ...
    `,
		...
		pepperfoxMSDFRef3.current.geometry = geometry;
		pepperfoxMSDFRef3.current.material = material;
		pepperfoxMSDFRef3.current.scale.set(0.004, 0.004, 0.004);
		pepperfoxMSDFRef3.current.position.set(-0.4, 0, 0);
		pepperfoxMSDFRef3.current.rotation.set(
			0,
			(180 * Math.PI) / 180,
			(180 * Math.PI) / 180
		);
