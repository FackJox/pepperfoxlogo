 ...
 const progressTest = 0.2
    ...
    `,
        ...
        void main() {
			...
			vec3 red = vec3(0.282,0.153,0.286);
    ...
    `,
		...
		pepperfoxMSDFRef2.current.geometry = geometry;
		pepperfoxMSDFRef2.current.material = material;
		pepperfoxMSDFRef2.current.scale.set(0.004, 0.004, 0.004);
		pepperfoxMSDFRef2.current.position.set(-0.4, -0.25, 0);
		pepperfoxMSDFRef2.current.rotation.set(
			0,
			(180 * Math.PI) / 180,
			(180 * Math.PI) / 180
		);
