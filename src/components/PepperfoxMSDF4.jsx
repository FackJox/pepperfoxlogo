 ...
 const progressTest = 0.2
    ...
    `,
        ...
        void main() {
			...
			vec3 red = vec3(0.918,0.569,0.741);

            // Outputs
            #include <three_msdf_strokes_output>

			vec4 l1 = vec4(red, border * 0.3);
			vec4 l2 = vec4(red, border);
			vec4 l3 = vec4(red, outset);
			vec4 l4 = vec4(orange, outset);
    ...
    `,
		...
		pepperfoxMSDFRef4.current.geometry = geometry;
		pepperfoxMSDFRef4.current.material = material;
		pepperfoxMSDFRef4.current.scale.set(0.004, 0.004, 0.004);
		pepperfoxMSDFRef4.current.position.set(-0.4, 0.25, 0);
		pepperfoxMSDFRef4.current.rotation.set(
			0,
			(180 * Math.PI) / 180,
			(180 * Math.PI) / 180
		);
